...
public class Registros implements Serializable {
  ...
  /**
   * Campos regemp (Registro de empleados) es un arreglo del tipo Empleado,
   * inicialmente vacío.
   */
   ...
   * 
   * @param str Cadena a buscar pos Determina la posición desde donde se buscará
   *            en el arreglo
  ...
  public int buscar(String str, int pos) {
    ...
    /**
     * Averiguar si str esta contenida en el campo nombre de la clase Empleado ¿str
     * está contenida en nombre? indexOf(String str) Devuelve la posición del
     * elemento buscado De no encontrar el elemento regresar -1
     */
  ...
  /**
   * Elimina un objeto Empleado de la lista utilizando el número de empleado como
   * criterio de selección.
   * 
   * @param numemp Número de empleado del registro del trabajador a eliminar Se
   *               elimina el objeto Empleado
   */
   ...
   * registro no exista.
   * 
   * @param bus Guarda el valor recibido como condición (número de empleado) de
   *            búsqueda
   * @return
   */
